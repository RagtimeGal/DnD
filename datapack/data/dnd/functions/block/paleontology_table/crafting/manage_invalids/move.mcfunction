...
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0}] unless block ~ ~ ~ barrel{Items:[{Slot:11b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 11b
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0}] unless block ~ ~ ~ barrel{Items:[{Slot:12b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 12b
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0}] unless block ~ ~ ~ barrel{Items:[{Slot:13b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 13b
...
execute if entity @s[predicate=dnd:block/paleontology_table/invalid_items] run function dnd:block/paleontology_table/crafting/manage_invalids/export
