...
# Osteoderm Chestplate
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0}] if data storage dnd:storage root.temp{crafting_input:{0:[{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:0b},{id:"minecraft:air",Slot:1b},{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:2b}],1:[{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:0b},{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:1b},{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:2b}],2:[{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:0b},{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:1b},{tag:{dnd:{id:"ankylosaurid_osteoderm"}},Slot:2b}]}} run loot replace block ~ ~ ~ container.16 loot dnd:items/osteoderm_chestplate
# Tooth Club
execute store result score @s dnd.dummy if entity @s[scores={dnd.dummy=0}] if data storage dnd:storage root.temp{crafting_input:{0:[{tag:{dnd:{id:"apex_tooth"}},Slot:0b},{tag:{dnd:{id:"apex_tooth"}},Slot:1b},{tag:{dnd:{id:"apex_tooth"}},Slot:2b}],1:[{tag:{dnd:{id:"apex_tooth"}},Slot:0b},{id:"minecraft:wooden_sword",Slot:1b},{tag:{dnd:{id:"apex_tooth"}},Slot:2b}],2:[{tag:{dnd:{id:"apex_tooth"}},Slot:0b},{tag:{dnd:{id:"apex_tooth"}},Slot:1b},{tag:{dnd:{id:"apex_tooth"}},Slot:2b}]}} run loot replace block ~ ~ ~ container.16 loot dnd:items/tooth_club
