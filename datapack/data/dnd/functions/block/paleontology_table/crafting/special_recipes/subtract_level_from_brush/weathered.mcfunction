####################
# Turns Oxidized Brush into Weathered Brush
####################

data modify storage dnd:storage root.temp.brush_data set from block ~ ~ ~ Items[{tag:{dnd:{id:"brush"}}}]
data modify storage dnd:storage root.temp.brush_data.tag.CustomModelData set value 400006
data modify storage dnd:storage root.temp.brush_data.tag.dnd.uses set value 0
data modify storage dnd:storage root.temp.brush_data.tag.dnd.level set value 2
data modify storage dnd:storage root.temp.brush_data.tag.display.Name set value '{"translate":"item.dnd.weathered_brush","italic":"false"}'
