...
execute if score #is_falling dnd.dummy matches 0 run function dnd:block/suspicious_packed_ice/base_missing/check
execute if score #is_falling dnd.dummy matches 1 run function dnd:block/suspicious_packed_ice/base_missing/passenger