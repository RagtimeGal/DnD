...
execute if data storage dnd:storage root.temp.item_to_dna_data.genome{identifier:"sculk"} run data modify storage dnd:storage root.temp.item_to_dna_data.lore append value '{"translate":"lore.dnd.identifier","color":"gray","italic":false,"with":[{"translate":"lore.dnd.identifier.sculk"}]}'
