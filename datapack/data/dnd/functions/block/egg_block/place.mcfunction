...
# Place Egg
execute positioned ~ ~1 ~ align xyz positioned ~0.5 ~0.5 ~0.5 run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:furnace",Count:1b,tag:{CustomModelData:401001}}],Tags:["global.ignore","dnd.block","dnd.entity","dnd.egg_block","dnd.newly_spawned_egg"],NoGravity:1b,Invisible:1b,Marker:1b}
# Execute as temp
