...
execute as @p[gamemode=!spectator,tag=dnd.inside_genetic_workstation_gui] at @s run summon item ~ ~ ~ {Item:{id:"stone",Count:1b},Tags:["dnd.replace_item","smithed.entity","smithed.strict"]}
