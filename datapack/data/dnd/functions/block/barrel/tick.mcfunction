...
execute as @e[type=villager,distance=..2,nbt={VillagerData:{profession:"minecraft:fisherman"},Xp:0},tag=!dnd.paleontologist] if data entity @s Brain.memories."minecraft:job_site" run function dnd:block/barrel/check_paleontologist
