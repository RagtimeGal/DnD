...
## Antivillager fix
execute as @e[type=#dnd:hates_villagers,team=!smithed.prevent_aggression] run team join smithed.prevent_aggression @s[tag=!smithed.entity,tag=!smithed.strict]
