...
execute align xyz run summon wandering_trader ~0.5 ~1 ~0.5 {Offers:{Recipes:[]},DeathTime:19s,Team:"global.antivil",Health:0.1f,NoAI:1b,NoGravity:1b,Silent:1b,Tags:["smithed.entity","smithed.strict","dnd.newly_spawned_fossil_stand","dnd.fossil_stand","dnd.ten_second_clock"],ArmorDropChances:[-10000.0f,-10000.0f,-10000.0f,-10000.0f],HandDropChances:[10000.0f,10000.0f]}
