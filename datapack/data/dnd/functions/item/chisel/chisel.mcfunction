...
execute if block ~ ~ ~ minecraft:spawner{SpawnData:{ArmorItems:[{},{},{},{tag:{dnd:{}}}]}} run function dnd:item/chisel/chisel/spawner
execute if entity @s[scores={dnd.dummy=1}] run playsound dnd:item.chisel.use block @a[distance=..16]
execute if entity @s[scores={dnd.dummy=1}] run function dnd:item/durability/damage_generic_amount/mainhand_1
