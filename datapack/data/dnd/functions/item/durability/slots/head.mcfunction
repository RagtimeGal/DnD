...
data modify storage dnd:storage root.temp.item set from entity @s Inventory[{Slot:103b}]

# Sets the item's data in storage
function dnd:item/durability/modify/main
execute unless data storage dnd:storage root.temp.item run item replace entity @s armor.head with air
item modify entity @s armor.head dnd:durability_lore
data modify storage dnd:storage root.temp.item set from entity @s Inventory[{Slot:103b}]
...
item modify entity @s armor.head dnd:copy_nbt
