...
execute if data storage dnd:storage root.temp.genome{is_bucket:1b} run data modify entity @s ArmorItems[3].tag.dnd.genome set from storage dnd:storage root.temp.genome
execute unless data storage dnd:storage root.temp.genome.custom_entity_data run data modify entity @s DeathLootTable set value "dnd:none"
