...
data merge entity @s {text:'{"translate":"item.dnd.tooltip.modified","with":[{"selector":"@e[tag=dnd.temp,distance=..0.5,limit=1]","italic":false,"color":"gray"}],"italic":false,"color":"gray"}'}
...
data merge entity @s {text:'{"translate":"item.dnd.dna_vial","with":[{"translate":"item.dnd.tooltip.modified","with":[{"selector":"@e[tag=dnd.temp,distance=..0.5,limit=1]","italic":false,"color":"white"}],"italic":false,"color":"white"}],"italic":false,"color":"white"}'}
