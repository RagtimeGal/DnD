####################
# Summons a Gigantopithecus
####################

# Spawns Loot
loot spawn ~ ~ ~ loot dnd:items/gigantopithecus_primary_fossil
...
# Summon Command
tellraw @s {"translate":"commands.summon.success","with": [{"translate":"entity.dnd.gigantopithecus"}]}
