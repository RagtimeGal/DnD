####################
# Summons a Triceratops
####################

# Spawns Loot
loot spawn ~ ~ ~ loot dnd:items/triceratops_primary_fossil
...
# Summon Command
tellraw @s {"translate":"commands.summon.success","with": [{"translate":"entity.dnd.triceratops"}]}
