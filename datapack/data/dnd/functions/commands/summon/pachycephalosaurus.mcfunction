####################
# Summons a Pachycephalosaurus
####################

# Spawns Loot
loot spawn ~ ~ ~ loot dnd:items/pachycephalosaurus_primary_fossil
...
# Summon Command
tellraw @s {"translate":"commands.summon.success","with": [{"translate":"entity.dnd.pachycephalosaurus"}]}
