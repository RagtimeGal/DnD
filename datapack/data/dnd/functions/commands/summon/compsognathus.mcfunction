####################
# Summons a Compsognathus
####################

# Spawns Loot
loot spawn ~ ~ ~ loot dnd:items/compsognathus_primary_fossil
...
# Summon Command
tellraw @s {"translate":"commands.summon.success","with": [{"translate":"entity.dnd.compsognathus"}]}
